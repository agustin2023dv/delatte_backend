...
import { RestauranteUbicacionService } from "../services/restauranteUbicacion.service";
...
export const getNearbyRestaurantsController = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    const nearbyRestaurants = await RestauranteUbicacionService.getNearbyRestaurants(latitude, longitude, searchRadius);
