...
import { registerRestaurantAndManagerController, getRestaurantByIdController, updateRestaurantController, getRestaurantsByManagerIdController, getAllRestaurantsController, getSearchResultsController, removePhotoFromGalleryController, addPhotoToGalleryController, getGalleryPhotosController, checkManagerRoleController, getNearbyRestaurantsController } from '../controllers/restaurante.controller';
...
router.post('/register-restaurant', registerRestaurantAndManagerController);
...
router.put('/:id', authMiddleware, managerOfRestaurantMiddleware, // Verificar que sea el manager del restaurante o superadmin
updateRestaurantController);
//*Ruta para obtener los restaurantes gestionados por un manager
router.get('/manager/:id', getRestaurantsByManagerIdController);
...
router.post("/:id/gallery", authMiddleware, managerOfRestaurantMiddleware, uploadMiddleware, // Middleware de multer para manejar la subida de archivos
...
router.get('/:restaurantId/is-manager', authMiddleware, checkManagerRoleController);
// Ruta para obtener restaurantes cercanos
router.get("/nearby/:lng/:lat/:radius", validateLocationParams, getNearbyRestaurantsController);
