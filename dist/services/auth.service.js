...
export const resetPasswordService = async (token, userId, newPassword) => {
...
export const changePasswordService = async (userId, oldPassword, newPassword, confirmNewPassword) => {
