...
exports.RestaurantGalleryService = void 0;
const inversify_1 = require("inversify");
const restaurantGallery_types_1 = require("../types/restaurantGallery.types");
let RestaurantGalleryService = class RestaurantGalleryService {
    restaurantGalleryRepo;
    constructor(restaurantGalleryRepo) {
        this.restaurantGalleryRepo = restaurantGalleryRepo;
    }
...
exports.RestaurantGalleryService = RestaurantGalleryService;
exports.RestaurantGalleryService = RestaurantGalleryService = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(restaurantGallery_types_1.RESTAURANT_GALLERY_TYPES.IRestaurantGalleryRepository)),
